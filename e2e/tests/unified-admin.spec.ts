...
const migration = JSON.parse(readFileSync('../scripts/commerce-routes.json','utf8'))
const platformPaths: string[] = JSON.parse(readFileSync('../scripts/platform-routes.json','utf8'))
