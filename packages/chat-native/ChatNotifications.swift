    ...
    var body: some View {
        if !notifications.enabled || notifications.error != nil {
            Button {
                ...
                .font(.system(size:12)).foregroundStyle(Color(red:0.78,green:0.66,blue:0.43))
                .padding(14).background(Color.white.opacity(0.035),in:RoundedRectangle(cornerRadius:13))
