...
<style scoped>.design-manager{padding:22px;border:1px solid var(--color-border,#ded5c9);border-radius:14px;margin-bottom:24px}header{display:flex;justify-content:space-between;gap:20px;align-items:center}h2{font-size:20px;margin:0 0 8px}p,.muted{color:var(--color-text-secondary,#897b6b);font-size:12px;line-height:1.7}p{margin:0 0 16px}.filters{display:flex;flex-wrap:wrap;gap:10px;margin-bottom:18px}.el-pagination{margin-top:20px;overflow:auto}a{margin-right:12px;color:#aa794a;text-decoration:none}</style>
