...
<style scoped>
.points-page{padding:4px;min-width:0}.points-heading{display:flex;align-items:center;justify-content:space-between;gap:16px}.points-heading h1{font-size: var(--type-size-hero);margin:8px 0}.eyebrow{font-size: var(--type-size-micro);letter-spacing:3px;color:var(--admin-accent)}.product-cell{display:flex;align-items:center;gap:12px}.product-cell img{width:48px;height:56px;object-fit:cover;border-radius:8px}.product-cell small{display:block;color:var(--admin-text-secondary);margin-top:4px}.toolbar{flex-wrap:wrap}.intro{color:var(--admin-text-secondary)}.metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin:24px 0}.metrics strong{display:block;font-size: var(--type-size-hero);margin-top:12px}.toolbar{display:flex;align-items:center;gap:12px;margin:16px 0}@media(max-width:700px){.points-page{padding:12px}.metrics{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.metrics strong{font-size: var(--type-size-page)}}
</style>
