...
enum ImageMapper {
    ...
    static let templeImages: [String: String] = [
        "白马寺": "temple-card-baimasi",
        "少林寺": "temple-card-shaolinsi",
        "灵隐寺": "temple-card-lingyinsi",
        "青羊宫": "temple-card-qingyanggong",
        "法门寺": "temple-card-famensi",
        "大昭寺": "temple-card-dazhaosi",
    ]

    /// 法师法名 → 本地 asset 名
    static let masterAvatars: [String: String] = [
        "释明远": "master-avatar-shimingyuan",
        "清风道长": "master-avatar-qingfeng",
        "扎西多吉": "master-avatar-zhaxiduoji",
        "智海": "master-avatar-zhihai",
        "妙音": "master-avatar-miaoyin",
        "张志顺": "master-avatar-zhangzhishun",
    ]
