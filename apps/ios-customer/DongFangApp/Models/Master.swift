...
extension Master {
    /// 对齐原型 master-list.html 法师列表（6位法师）
    static let mockData: [Master] = [
        Master(id: "M001", dharmaName: "释明远", layName: "王远山", templeId: "T002",
               templeName: "少林寺", position: "方丈", sect: "禅宗", type: "佛教",
               authStatus: "已认证", specialties: ["禅宗修行", "禅修指导"],
               avatar: "master-avatar-shimingyuan", rating: 4.9, isOnline: true, startPrice: 388,
               yearsOfPractice: 30, consultationCount: 12680),
        Master(id: "M002", dharmaName: "清风道长", layName: "李信军", templeId: "T002",
               templeName: "白云观", position: "高功法师", sect: "全真派", type: "道教",
               authStatus: "已认证", specialties: ["道教符箓", "风水堪舆"],
               avatar: "master-avatar-qingfeng", rating: 4.8, isOnline: true, startPrice: 288,
               yearsOfPractice: 25, consultationCount: 8320),
        Master(id: "M003", dharmaName: "扎西多吉", layName: "—", templeId: "T006",
               templeName: "塔尔寺", position: "活佛", sect: "藏密", type: "佛教",
               authStatus: "已认证", specialties: ["唐卡解读", "藏传密法"],
               avatar: "master-avatar-zhaxiduoji", rating: 4.9, isOnline: true, startPrice: 458,
               yearsOfPractice: 18, consultationCount: 5460),
        Master(id: "M004", dharmaName: "智海法师", layName: "陈建华", templeId: "T003",
               templeName: "灵隐寺", position: "首座", sect: "天台宗", type: "佛教",
               authStatus: "已认证", specialties: ["华严经义", "禅修指导"],
               avatar: "master-avatar-zhihai", rating: 4.7, isOnline: false, startPrice: 328,
               yearsOfPractice: 22, consultationCount: 9150),
        Master(id: "M005", dharmaName: "妙音法师", layName: "—", templeId: "T005",
               templeName: "普陀山", position: "尼师", sect: "净土宗", type: "佛教",
               authStatus: "已认证", specialties: ["观音法门", "诵经超度"],
               avatar: "master-avatar-miaoyin", rating: 4.8, isOnline: true, startPrice: 268,
               yearsOfPractice: 20, consultationCount: 6890),
        Master(id: "M006", dharmaName: "张志顺道长", layName: "—", templeId: "T004",
               templeName: "武当山", position: "道长", sect: "全真派", type: "道教",
