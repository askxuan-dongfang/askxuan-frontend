...
instance.interceptors.request.use(
  (config: InternalAxiosRequestConfig) => {
    const token = localStorage.getItem('df_temple_admin_token')
...
async function refreshAccessToken(): Promise<string | null> {
  const refreshToken = localStorage.getItem('df_temple_admin_refresh_token')
  ...
  localStorage.setItem('df_temple_admin_token', data.data.accessToken)
