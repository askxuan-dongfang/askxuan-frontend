...
<template>
  ...
  >
    ...
    <aside id="admin-navigation" ref="sidebarRef" class="ax-admin-sidebar" tabindex="-1" :role="mobile ? 'dialog' : undefined" :aria-modal="mobile && drawerOpen ? true : undefined" :inert="mobile && !drawerOpen" aria-label="寺院管理台主导航">
